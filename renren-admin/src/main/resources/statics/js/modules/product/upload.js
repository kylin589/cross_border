$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [			
			...
			{ label: '店铺id', name: 'authorizeShop', index: 'authorize_shop', width: 80 }, 			
			...
			{ label: '亚马逊分类一级id', name: 'amazonCategoryOneId', index: 'amazon_category_one_id', width: 80 }, 			
			{ label: '亚马逊分类二级id', name: 'amazonCategoryTwoId', index: 'amazon_category_two_id', width: 80 }, 			
			{ label: '亚马逊分类三级id', name: 'amazonCategoryThreeId', index: 'amazon_category_three_id', width: 80 }, 			
			{ label: '亚马逊分类四级id', name: 'amazonCategoryFourId', index: 'amazon_category_four_id', width: 80 }, 			
			{ label: '亚马逊分类五级id', name: 'amazonCategoryFiveId', index: 'amazon_category_five_id', width: 80 }, 			
			...
			{ label: '', name: 'uploadTime', index: 'upload_time', width: 80 }			
        ],
		viewrecords: true,
        height: 385,
        rowNum: 10,
