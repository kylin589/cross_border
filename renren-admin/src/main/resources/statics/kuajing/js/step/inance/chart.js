...
function allChartJ1(d,t) {
    var dom = document.getElementById("allChartJ1");
    console.log(dom);
    var myChart = echarts.init(dom);
...
function allChartJ2(d,t) {
    var dom = document.getElementById("allChartJ2");
    var myChart = echarts.init(dom);
    var app = {};
    option = null;
...
function allChartJ3(d) {
    var dom = document.getElementById("allChartJ3");
    var myChart = echarts.init(dom);
    var app = {};
    option = null;
...
function allChartY2(d,t) {
    var dom = document.getElementById("allChartY2");
    var myChart = echarts.init(dom);
    var app = {};
    option = null;
...
function allChartY3(d) {
    var dom = document.getElementById("allChartY3");
    var myChart = echarts.init(dom);
    var app = {};
    option = null;
