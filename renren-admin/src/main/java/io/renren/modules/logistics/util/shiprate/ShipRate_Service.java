 ...
 * 提供国际小包费率查询web服务
 * 
 * This class was generated by Apache CXF 2.7.14 2015-06-08T18:02:43.343+08:00
 * Generated source version: 2.7.14
 * 
 */
@WebServiceClient(name = "ShipRate", wsdlLocation = "http://www.sfcservice.com/ishipsvc/web-service?wsdl", targetNamespace = "http://www.example.org/ShipRate/")
public class ShipRate_Service extends Service {
	...
	public final static QName ShipRateSOAP = new QName(
			"http://www.example.org/ShipRate/", "ShipRateSOAP");
	static {
		URL url = null;
		try {
			...
			java.util.logging.Logger
					.getLogger(ShipRate_Service.class.getName())
					.log(java.util.logging.Level.INFO,
							"Can not initialize the default wsdl from {0}",
							"http://www.sfcservice.com/ishipsvc/web-service?wsdl");
		}
		WSDL_LOCATION = url;
	}
