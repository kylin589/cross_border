...
public class NewOrderAbroadLogisticsEntity implements Serializable {
     ...
     * 国际运费
     */
    private BigDecimal actualInterFreight;
    /**
     * 是否同步（默认0：没有  1：有）
     */
    ...
    public BigDecimal getActualInterFreight() {
        return actualInterFreight;
    }

    public void setActualInterFreight(BigDecimal actualInterFreight) {
        this.actualInterFreight = actualInterFreight;
    }
}
